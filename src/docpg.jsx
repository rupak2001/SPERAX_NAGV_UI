...
var Docpg = (props) => {
    if (window.innerWidth <= 767) {
        ...
        window.onscroll = function () {
            ...
            if (prevScrollpos > currentScrollPos) {
                ...
                document.getElementById("forum_link").style.display = "unset";
            } else {
                document.getElementById("themeSwitch").style.display = "none";
                document.getElementById("forum_link").style.display = "none";
            }
            prevScrollpos = currentScrollPos;
        }
    }
    var [change_bg_ini, change_bg_up] = useState({
        change_icon: <DarkModeIcon id="themeIcon" />,
    ...
    return (
        <div className="docpagediv" style={{ backgroundImage: `url(${change_bg_ini.change_bgPic})`, backgroundSize: "cover", backgroundAttachment: "fixed", height: "100%", width: "100%" }}>
            <header id="header_box" className={change_bg_ini.change_boxcolor} style={{ position: "fixed", zIndex: "10", width: "100%" }}>
                <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                    ...
                    <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
                        ...
                        <a id = "forum_link" style = {{display:"unset"}} href="https://forum.sperax.io/" className="mr-5 hover:text-white">Forum</a>
                    </nav>
